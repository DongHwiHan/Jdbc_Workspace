...
public class MemberView {
	...
	/**
	 * 회원추가용 화면 추가하고자하는 회원의 정보를 입력받아서 추가 요청할 수 있는 화면.
	 */
	...
	public void selectByUserId() {
		...
		// 입력한 유저 아이디 값을 매개변수로 넘겨서 회원아이디 검색 요청.
	...
	/**
	 * 사용자에게 변경할 회원의 아이디, 변경할 정보들(비밀번호, 이메일, 휴대폰번호, 주소)을 입력받은 후 변경요청하는 메서드
	 */
