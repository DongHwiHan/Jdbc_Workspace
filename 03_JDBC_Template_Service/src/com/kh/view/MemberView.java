...
//		회원 전체 조회 요청
	...
	/**
	 * 사용자에게 검색할 회원의 아이디를 입력받고 조회 요청하는 메서드
	 */
...
//		입력한 유저 아이디값을 매개변수로 넘겨서 회원아이디 검색 요청.
	...
	public void selectByUserName() {
		...
		String keyword = sc.nextLine(); // 민경민 민정민 민동민  '민' 하나로 모두 찾을수 있는  -> USERNAME like '%민%'
		
		mc.selectByUserName(keyword);
	}

	/**
	 * 사용자에게 변경할 회원의 아이디, 변경할 정보들(비밀번호, 이메일, 휴대폰번호, 주소)을 입력받은후
	 * 변경요청하는 메소드
	 */
